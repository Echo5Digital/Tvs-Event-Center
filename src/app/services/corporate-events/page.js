...
import { Building2, Calendar, Users, MapPin, CheckCircle, Star, ArrowLeft, Phone, Mail, Wifi, Monitor, Crown } from 'lucide-react'
    ...
    <>
      ...
      <main>
        ...
        <section className="section-padding bg-gradient-to-r from-amber-600 to-orange-600 text-white">
          <div className="max-w-4xl mx-auto container-padding text-center text-white">

            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
              Ready to Host Your Corporate Event?
            </h2>
            <p className="text-xl mb-8 text-gold-100">
              Let's create a professional and memorable business gathering
            </p>
