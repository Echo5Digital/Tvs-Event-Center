...
import { PartyPopper, Calendar, Users, MapPin, CheckCircle, Star, ArrowLeft, Phone, Mail, Gift, Cake } from 'lucide-react'
      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="flex items-center text-gray-700">
                    <Cake className="w-5 h-5 text-purple-600 mr-3" />
                ...
                <Link 
                  href="/contact"
                  className="bg-purple-600 hover:bg-purple-700 text-white font-medium px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center"
                >
        ...
        <section className="section-padding bg-white">
          <div className="max-w-7xl mx-auto container-padding">
            <SectionHeading
              ...
              description="Tailored celebrations for every milestone"
            />

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {specialEventsService.packages.map((pkg, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className={`relative bg-white rounded-lg shadow-xl p-8 border-2 transition-all duration-300 hover:shadow-2xl ${
                    index === 1 ? 'border-purple-400 transform scale-105' : 'border-gray-200 hover:border-purple-300'
                  }`}
                >
                  {index === 1 && (
        ...
        <section className="section-padding bg-gradient-to-r from-purple-600 to-pink-600 text-white">
          <div className="max-w-4xl mx-auto container-padding text-center">
            <SectionHeading
              title="Ready to Celebrate Your Special Event?"
              description="Let's create unforgettable memories for your milestone moment"
            />
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/contact"
                className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold transition-colors flex items-center"
              >
              ...
              <a
                ...
                className="border-2 border-white text-white hover:bg-white hover:text-purple-600 px-8 py-3 rounded-lg font-semibold transition-colors flex items-center"
              >
